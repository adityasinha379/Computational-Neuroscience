...
%
%     vihc = catmodel_IHC(pin,CF,nrep,tdres,reptime,cohc,cihc);
...
% implnt is for "approximate" or "actual" implementation of the power-law functions: "0" for approx. and "1" for actual implementation
% 
%
% For example,
%
%    vihc = catmodel_IHC(pin,1e3,10,1/100e3,0.200,1,1); **requires 7 input arguments
%    [synout,psth] = catmodel_Synapse(vihc,1e3,10,1/100e3,3,0); **requires 6 input arguments
%
% models a normal fiber of high spontaneous rate (normal OHC & IHC function) with a CF of 1 kHz, 
% for 10 repititions and a sampling rate of 100 kHz, for a repetition duration of 200 ms, and
